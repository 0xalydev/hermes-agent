...
export function buildChatOnboardingPrompt(): string {
  return [
    ...
    '4. The moment you save their context line, their dashboard card appears right under your reply — designing itself from their answers. Tell them in one short sentence to keep the modules they want, drop the rest, and press Continue.',
