...
export function buildChatOnboardingPrompt(): string {
  return [
    ...
    '7. Now the payoff: their screen\'s modules were designed from everything they told you and are listed in the next card — tell them to keep what they want and drop what they don\'t (one short sentence), then include the line ::onboarding{step="first-screen"}',
