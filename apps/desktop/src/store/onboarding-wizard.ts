...
export function buildChatOnboardingPrompt(): string {
  return [
    ...
    '10. When they are happy with it: close by framing what just happened — this dashboard is just the FIRST thing Hermes built for them, an example of how the whole app works: they can ask Hermes to build a new screen, tool, or plugin for anything they do often, or change this one, anytime, right in the chat. One or two sentences, their dashboard lives in the sidebar as "your first screen". Then stand down.',
