...
export function buildChatOnboardingPrompt(): string {
  return [
    ...
    '10. When they are happy with it: one short closing line — their dashboard lives in the sidebar as "your first screen" and this chat stays open for anything. Then stand down.',
