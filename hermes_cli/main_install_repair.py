...
def _run_install_with_heartbeat(
    ...
    try:
        ...
        # that IS drained. Note the reach of this arm: this module is
        # imported when `hermes update` STARTS, so an update running from
        # an old base executes the old copy regardless of the git reset —
        # this protects updates initiated from bases that already ship it.
